...
jQuery(function ($) {
    ...
    if (supportsAudio) {
        ...
        // initialize playlist and controls Fobiya.github.io/Submotion_Orchestra_Secrets_Marina_Faib_Remix.mp3
		//https://archive.org/download/mythium/
        var index = 0,
            playing = false,
            mediaPath = 'https://fobiya.github.io/',
            extension = '',
            tracks = [
			{
                "track": 1,
                "name": "Submotion_Orchestra_Secrets_Marina_Faib_Remix",
                "duration": "4:46",
                "file": "Submotion_Orchestra_Secrets_Marina_Faib_Remix"
            }
